...
import { Request as Request$1 } from 'miniflare';
...
declare function toMiniflareRequest(request: Request): Request$1;

export { type InternalMiniOxygenOptions, type MiniOxygen, type MiniOxygenViteOptions, WARMUP_PATHNAME, getViteUrl, setupOxygenMiddleware, startMiniOxygenRuntime, toMiniflareRequest };
